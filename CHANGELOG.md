...
- Fixed visual styles for list builder view checklist checkbox labels. [blackbaud/skyux-list-builder-view-checklist#21](https://github.com/blackbaud/skyux-list-builder-view-checklist/pull/21)
