...
export class SkyUXStylesActionButtonsComponent {
  public routes = [
    ...
    {
      name: 'Typography',
      path: '/design/ux-styles/typography',
      icon: 'font',
      // tslint:disable-next-line
