...
- Fixed toast service to remove the toaster component if all toast component instances have been closed. [blackbaud/skyux-toast#9](https://github.com/blackbaud/skyux-toast/pull/9)
