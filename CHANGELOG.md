...
- Fixed the metadata files for all `@skyux` packages for backwards compatibility with TypeScript 2. [#2375](https://github.com/blackbaud/skyux2/pull/2375)
...
- Added methods to `SkyWaitService` to launch a wait component until an observable is completed. [blackbaud/skyux-indicators#39](https://github.com/blackbaud/skyux-indicators/pull/39) (Thanks [@Blackbaud-ColbyWhite](https://github.com/Blackbaud-ColbyWhite)!)
- Added `sky-list-toolbar-search-actions` to the list toolbar's child components. [blackbaud/skyux-list-builder#52](https://github.com/blackbaud/skyux-list-builder/pull/52) (Thanks [@blackbaud-vimal-kumar](https://github.com/blackbaud-vimal-kumar)!)
- Added `activeIndex` to the repeater component properties to indicate which repeater item shows an active state. [blackbaud/skyux-lists#51](https://github.com/blackbaud/skyux-lists/pull/51)
...
- Fixed `SkyDatePipe` to work as an `Injectable`. [blackbaud/skyux-datetime#66](https://github.com/blackbaud/skyux-datetime/pull/66)
- Fixed the flyout component to not error when used with Angular 7. [blackbaud/skyux-flyout#56](https://github.com/blackbaud/skyux-flyout/pull/56)
- Fixed the flyout component to support child components that use `ChangeDetectionStrategy.Default`. [blackbaud/skyux-flyout#60](https://github.com/blackbaud/skyux-flyout/pull/60)
- Fixed the radio group component to update the state when the model value changes. [blackbaud/skyux-forms#52](https://github.com/blackbaud/skyux-forms/pull/52)
- Fixed the toolbar section component to properly display items which do not overflow onto the next line. [blackbaud/skyux-layout#42](https://github.com/blackbaud/skyux-layout/pull/42)
- Fixed the list component to properly notify consumers when filters are removed. [blackbaud/skyux-list-builder#60](https://github.com/blackbaud/skyux-list-builder/pull/60)
- Fixed the filter summary component to have correct spacing between filter summary items. [blackbaud/skyux-lists#42](https://github.com/blackbaud/skyux-lists/pull/42)
- Fixed the search component to handle searches with no applied value. [blackbaud/skyux-lookup#34](https://github.com/blackbaud/skyux-lookup/pull/34)
- Fixed the modal component to properly align the expand and collapse chevron in tile headers. [blackbaud/skyux-modals#49](https://github.com/blackbaud/skyux-modals/pull/49)
- Fixed the modal component to only close when the escape key is released. [blackbaud/skyux-modals#62](https://github.com/blackbaud/skyux-modals/pull/62) (Thanks [@Blackbaud-JackMcElhinney](https://github.com/Blackbaud-JackMcElhinney)!)
- Fixed the modal header buttons to wrap properly when the heading wraps to a new line. [blackbaud/skyux-modals#61](https://github.com/blackbaud/skyux-modals/pull/61) (Thanks [@Blackbaud-JackMcElhinney](https://github.com/Blackbaud-JackMcElhinney)!)
- Fixed `SkyTileModule` to import the missing `BrowserAnimationsModule`. [blackbaud/skyux-tiles#32](https://github.com/blackbaud/skyux-tiles/pull/32)
- Fixed the tile dashboard service to no longer cause undefined errors in a flyout component. [blackbaud/skyux-tiles#38](https://github.com/blackbaud/skyux-tiles/pull/38) (Thanks [@Blackbaud-KrisMahon](https://github.com/Blackbaud-KrisMahon)!)
- Fixed the tile dashboard service to better handle errors when loading user configuration settings. [blackbaud/skyux-tiles#38](https://github.com/blackbaud/skyux-tiles/pull/38) (Thanks [@Blackbaud-KrisMahon](https://github.com/Blackbaud-KrisMahon)!)
...
- Added support for `microedge-rxstate@>=2.0.2` to various components. [blackbaud/skyux-list-builder#33](https://github.com/blackbaud/skyux-list-builder/pull/33) [blackbaud/skyux-list-builder-view-checklist#26] (https://github.com/blackbaud/skyux-list-builder-view-checklist/pull/26) [blackbaud/skyux-list-builder-view-grids#32](https://github.com/blackbaud/skyux-list-builder-view-grids/pull/32)
- Fixed `ListPagingComponent` and `SkyListViewGridComponent` to properly import `scan` RxJS operator. [blackbaud/skyux-list-builder#33](https://github.com/blackbaud/skyux-list-builder/pull/33) [blackbaud/skyux-list-builder-view-grids#32](https://github.com/blackbaud/skyux-list-builder-view-grids/pull/32)
...
- Updated peer dependency to prevent list view grid component from throwing `ExpressionChangedAfterItHasBeenCheckedError` when removing last item from page. [blackbaud/skyux-list-builder-view-grids#31](https://github.com/blackbaud/skyux-list-builder-view-grids/pull/31)
