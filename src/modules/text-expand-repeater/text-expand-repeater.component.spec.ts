...
describe('Text expand repeater component', () => {
  ...
  describe('basic behaviors', () => {
    it('should not have see more button if data is less than or equal to max items', () => {
      const fixture = TestBed.createComponent(TextExpandRepeaterTestComponent);
      const cmp = fixture.componentInstance as TextExpandRepeaterTestComponent;
      ...
      const seeMoreButton: any = el.querySelector('.sky-text-expand-repeater-see-more');
    ...
    it('should expand and collapse correctly', async(() => {
      ...
      const shownItemsSelector = '.sky-text-expand-repeater-item:not([style*="display: none"])';
      const hiddenItemsSelector = '.sky-text-expand-repeater-item[style*="display: none"]';
