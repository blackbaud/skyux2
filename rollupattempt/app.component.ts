...
import { SkyModule, SkyTileDashboardConfig } from 'skyux/core';
...
@NgModule({
  ...
  declarations: [ AppComponent, Tile1Component, Tile2Component ],
  entryComponents: [ Tile1Component, Tile2Component  ],
